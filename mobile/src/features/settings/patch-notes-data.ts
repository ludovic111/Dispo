...
export const patchNotes: readonly PatchNote[] = [
  {
    ...
    points: [
      'Profil, Mon répertoire et Disponibilités ont chacun leur onglet.',
      'Retrouve les pochettes, tonalités et BPM des morceaux, avec tes arrangements et ta maîtrise personnelle.',
      ...
      'Groupe et Premium sont disponibles avec des tarifs pour les écoles partenaires.',
      'La localisation reste facultative et s’actualise uniquement à ta demande.',
    ],
  },
  {
    version: '2.3',
  ...
  },
  {
    ...
    points: ['Feed de musiciens, profils et carte de Genève', 'Premières annonces SOS'],
  },
] as const;
