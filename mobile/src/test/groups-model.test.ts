...
describe('contrat JSON des morceaux de groupe', () => {
  it('décode le snake_case Swift/Supabase et canonise les UUID en minuscules', () => {
    const decoded = groupSongFromJson({
      ...
      canonical_song_id: 'ABCDEFAB-0000-0000-0000-000000000099',
      composer: 'Miles Davis',
      genre: 'Jazz',
      id: 'ABCDEFAB-0000-0000-0000-000000000001',
      isrc: 'USSM15900123',
      is_approved: true,
      metadata_source: 'apple-itunes-search',
      metadata_updated_at: '2026-08-31T12:00:00.000Z',
      platform_ids: { appleMusic: '123' },
      platform_links: { spotify: 'https://open.spotify.com/track/123' },
    ...
    expect(decoded).toMatchObject({
      catalogId: 'apple:123',
      canonicalSongId: 'abcdefab-0000-0000-0000-000000000099',
      composer: 'Miles Davis',
      genres: ['Jazz'],
      id: 'abcdefab-0000-0000-0000-000000000001',
      isrc: 'USSM15900123',
      ...
      platformLinks: { spotify: 'https://open.spotify.com/track/123' },
      solos: ['abcdefab-0000-0000-0000-000000000002'],
      tempoBpm: 118,
    });
