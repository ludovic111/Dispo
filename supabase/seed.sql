...
values ('00000000-0000-0000-0000-000000000000', '5b07c949-eb23-5cac-b866-1d10dc67abd5', 'authenticated', 'authenticated', 'marco@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Marco Fernández"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', '0c99c694-fafc-5ad8-a19c-f9717d5f55d3', 'authenticated', 'authenticated', 'sofia@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Sofia Almeida"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', '1912d9b6-90aa-51be-a69c-d5094c9e681f', 'authenticated', 'authenticated', 'julien@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Julien Perrin"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', '0b92f4a4-3a8f-5b7e-b41b-577f5d65cc14', 'authenticated', 'authenticated', 'anna@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Anna Kowalska"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', '10dd36a7-9a8c-51e3-bc08-631398d13eec', 'authenticated', 'authenticated', 'david@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"David Rochat"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', 'a368379a-dc49-5194-ac47-3374d0d28557', 'authenticated', 'authenticated', 'elise@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Élise Bonnet"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', '23fcbc32-a18d-5fde-b26d-c5507e458323', 'authenticated', 'authenticated', 'karim@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Karim Haddad"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', '965f3dcc-0086-576d-9c29-ffc46ab4de19', 'authenticated', 'authenticated', 'lea@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Léa Zbinden"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', '6d023718-28d9-5b0f-b505-c090b5c7c311', 'authenticated', 'authenticated', 'pablo@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Pablo Gutiérrez"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', 'a18d834d-022b-50b9-aac6-c5e7a6ba3b24', 'authenticated', 'authenticated', 'mathilde@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Mathilde Favre"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', '6b482648-f341-5124-8e24-a57481728a47', 'authenticated', 'authenticated', 'tom@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Tom Berger"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', '17bbcb90-e3e0-588a-96c3-fc31929ba1b5', 'authenticated', 'authenticated', 'nadia@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Nadia Benali"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', '20e621a1-6bb3-5ed7-94da-c34de9609f7c', 'authenticated', 'authenticated', 'stefan@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Stefan Meier"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', 'e8dd8168-b0f5-5ce6-8116-b3e9c5dffaff', 'authenticated', 'authenticated', 'camille@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Camille Dupraz"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', '56bf0fa3-2241-54d7-a663-ad456f4a10b0', 'authenticated', 'authenticated', 'ricardo@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Ricardo Mota"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', '9da874e4-b654-5d65-a462-0d9ccb9de678', 'authenticated', 'authenticated', 'hugo@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Hugo Steiner"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', 'cfdfe275-2e7a-5aa8-913a-fa0754ba383f', 'authenticated', 'authenticated', 'ingrid@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Ingrid Johansson"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', 'a9a0cf01-e56b-5e2b-b0fe-743851992bd3', 'authenticated', 'authenticated', 'yann@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Yann Broillet"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', '396eaacc-7544-51e4-b07f-8abf25e365c8', 'authenticated', 'authenticated', 'sarah@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Sarah Cohen"}', now(), now(), '', '', '', '');
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new)
values ('00000000-0000-0000-0000-000000000000', 'cb58436c-e5d2-5422-80cc-9d458d151d7d', 'authenticated', 'authenticated', 'antoine@demo.jamconnect.ch', crypt('jamconnect-demo', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"name":"Antoine Vullioud"}', now(), now(), '', '', '', '');
...
update public.profiles set
  ...
  bio = 'Congas, timbales, bongos. 20 ans de son cubain. J''organise des descargas chez moi à Carouge.', availability = 'Ce soir', repertoire = array['Manteca','Oye Como Va','Guantanamera','El Cuarto de Tula']::text[], photo_url = 'pfp_marco'
...
update public.profiles set
  ...
  bio = 'Chanteuse lusophone — bossa, salsa, soul. Je cherche un pianiste pour un duo régulier.', availability = 'Cette semaine', repertoire = array['Garota de Ipanema','Bésame Mucho','Ain''t No Sunshine']::text[], photo_url = 'pfp_sofia'
...
update public.profiles set
  ...
  bio = 'Contrebassiste, fan de Mingus. Dispo la plupart des soirs après 19h.', availability = 'Ce soir', repertoire = array['Autumn Leaves','All The Things You Are','So What','Blue Bossa']::text[], photo_url = 'pfp_julien'
...
update public.profiles set
  ...
  bio = 'Violoniste au Conservatoire. Je cherche un quatuor amateur motivé pour du Brahms.', availability = 'Sur demande', repertoire = array['Brahms — Quatuor op. 51','Dvořák — Quatuor américain','Bach — Partitas']::text[], photo_url = 'pfp_anna'
...
update public.profiles set
  ...
  bio = 'Batteur jazz, à l''aise en latin (songo, mambo). Mon studio à la Jonction est équipé.', availability = 'Ce soir', repertoire = array['Take Five','Spain','A Night in Tunisia']::text[], photo_url = 'pfp_david'
...
update public.profiles set
  ...
  bio = 'Flûtiste, 12 ans de conservatoire, je me mets au jazz. Patience appréciée !', availability = 'Indisponible', repertoire = array['Debussy — Syrinx','Summertime','Blue Bossa']::text[], photo_url = 'pfp_elise'
...
update public.profiles set
  ...
  bio = 'Guitariste rock & folk. Covers de Hendrix à Radiohead. Cherche bassiste et batteur.', availability = 'Ce week-end', repertoire = array['Little Wing','Karma Police','Wish You Were Here']::text[], photo_url = 'pfp_karim'
...
update public.profiles set
  ...
  bio = 'Bassiste groove, fan de Vulfpeck. Dispo les week-ends.', availability = 'Ce week-end', repertoire = array['Dean Town','Superstition','Come Together']::text[], photo_url = 'pfp_lea'
...
update public.profiles set
  ...
  bio = 'Trompettiste colombien. Salsa dura, boléro, mambo. J''ai joué 15 ans à Cali.', availability = 'Ce soir', repertoire = array['El Preso','Llorarás','Mambo No. 5','Sing Sing Sing']::text[], photo_url = 'pfp_pablo'
...
update public.profiles set
  ...
  bio = 'Violoncelliste amatrice sérieuse. Répertoire romantique, sonates et musique de chambre.', availability = 'Sur demande', repertoire = array['Schubert — Arpeggione','Fauré — Élégie','Beethoven — Sonates']::text[], photo_url = 'pfp_mathilde'
...
update public.profiles set
  ...
  bio = 'Beatmaker et live set modulaire. Cherche voix et instrumentistes pour des sessions studio.', availability = 'Cette semaine', repertoire = array['Sets house / ambient','Collabs hip-hop']::text[], photo_url = 'pfp_tom'
...
update public.profiles set
  ...
  bio = 'Choriste gospel et pianiste. Je monte un petit chœur soul sur Genève.', availability = 'Indisponible', repertoire = array['Oh Happy Day','Feeling Good','Georgia On My Mind']::text[], photo_url = 'pfp_nadia'
...
update public.profiles set
  ...
  bio = 'Sax ténor, habitué des scènes de l''AMR. Hard bop et ballades, dispo au pied levé.', availability = 'Ce soir', repertoire = array['Body and Soul','Moanin''','Cantaloupe Island','Footprints']::text[], photo_url = 'pfp_stefan'
...
update public.profiles set
  ...
  bio = 'Guitare acoustique et chant. Cercles folk au bord du lac l''été.', availability = 'Ce week-end', repertoire = array['Both Sides Now','The Boxer','Compositions perso']::text[], photo_url = 'pfp_camille'
...
update public.profiles set
  ...
  bio = 'Guitariste brésilien — samba, bossa, choro. Cavaquinho aussi !', availability = 'Sur demande', repertoire = array['Aquarela do Brasil','Wave','Tico-Tico no Fubá']::text[], photo_url = 'pfp_ricardo'
...
update public.profiles set
  ...
  bio = 'Batteur rock, pads électro hybrides. Local de répète à la Servette.', availability = 'Cette semaine', repertoire = array['Seven Nation Army','Time Is Running Out','Sets hybrides']::text[], photo_url = 'pfp_hugo'
...
update public.profiles set
  ...
  bio = 'Pianiste concertiste reconvertie au jazz. J''accompagne aussi des chanteurs.', availability = 'Ce soir', repertoire = array['Chopin — Ballades','Misty','My Funny Valentine']::text[], photo_url = 'pfp_ingrid'
...
update public.profiles set
  ...
  bio = 'Contrebasse et baby bass. Tumbaos salsa et walking jazz. Souvent au Chat Noir.', availability = 'Cette semaine', repertoire = array['El Cantante','Caravan','Footprints']::text[], photo_url = 'pfp_yann'
...
update public.profiles set
  ...
  bio = 'Chanteuse jazz, répertoire Ella & Billie. Je cherche un trio pour progresser.', availability = 'Sur demande', repertoire = array['Summertime','Fly Me to the Moon','God Bless the Child']::text[], photo_url = 'pfp_sarah'
...
update public.profiles set
  ...
  bio = 'Claviers Rhodes & orgue Hammond. Soul, funk, neo-soul. Home studio équipé.', availability = 'Indisponible', repertoire = array['What''s Going On','Lovely Day','Compositions neo-soul']::text[], photo_url = 'pfp_antoine'
